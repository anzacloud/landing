...
const workflowData = [
  ...
  },
  {
    title: "Affordable",
    text:
      "For a fraction of the cost and with the customer needs in mind, we are able to serve any size of business.",
  },
];

const WorkFlow = () => {
  return (
    <Box as="section" sx={styles.workflow} id="value">
      <Container>
        <BlockTitle
          sx={styles.workflow.blockTitle}
          tagline="Value We Give"
