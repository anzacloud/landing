...
const CtaThree = () => {
  return (
    <Box as="section" sx={styles.ctaThree} id="cta3">
      <Container>
            ...
            <Box className="my-auto">
              <Box sx={styles.ctaThree.content}>
                <BlockTitle
                  ...
                  heading={
                    "We provide softwares \n that are industry standard \n to SMEs and Corporates"
                  }
                />
                <Text as="p">
                  {
                    "Your main focus should be running your business. \n We step in to ensure that we provide solutions \n that will ease every process involved in your business. \n Our tools are developer friendly and equally easy to use \n for the average system users."
                  }
                </Text>
          ...
          <Box sx={styles.ctaThree.colOne}>
            <Grid sx={styles.ctaThree.grid}>
              <Box sx={styles.ctaThree.box}>
                ...
                <Text as="p">{"Solutions for \n your business"}</Text>
              </Box>
              <Box sx={styles.ctaThree.box}>
                <Heading sx={styles.ctaThree.color2} as="h3">
                  150+
                </Heading>
                <Text as="p">{"Businesses \n trust us"}</Text>
              </Box>
              <Box sx={styles.ctaThree.box}>
